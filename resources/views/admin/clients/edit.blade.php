                ...
                <div class="col-xs-6 form-group">
                    ...
                    <select id="sex" name="sex" class="form-control select2" required>
						...
						@foreach($genders as $gender)
							<option value="{{ $gender->id }}" {{ (old("sex") == $gender->id || $client->sex==$gender->id ? "selected":"") }}>{{ $gender->val_dsc }}</option>
						@endforeach
                    </select>
                    <p class="help-block"></p>
                    @if($errors->has('sex'))
                ...
                <div class="col-xs-6 form-group">
                    ...
                    <select id="addr_country" name="addr_country" class="form-control select2" required>
						...
						@foreach($countries as $country)
							<option value="{{ $country->id }}" {{ (old("addr_country") == $country->id || $client->addr_country==$country->id ? "selected":"") }}>{{ $country->val_dsc }}</option>
						@endforeach
                    </select>
                    <p class="help-block"></p>
                ...
                <div class="col-xs-6 form-group">
                    ...
                    <select id="addr_state" name="addr_state" class="form-control select2" required>
						...
						@foreach($states as $state)
							<option value="{{ $state->id }}" {{ (old("addr_state") == $state->id || $client->addr_state==$state->id ? "selected":"") }}>{{ $state->val_dsc }}</option>
						@endforeach
                    </select>
                    <p class="help-block"></p>
                    ...
                    <div class="col-xs-6 form-group">
                        ...
                        <select id="nok_relationship" name="nok_relationship" class="form-control select2" required>
                            ...
                            @foreach($nok_relationships as $relationship)
                                <option value="{{ $relationship->id }}" {{ (old("nok_relationship") == $relationship->id || $client->nok_relationship==$relationship->id ? "selected":"") }}>{{ $relationship->val_dsc }}</option>
                            @endforeach
                        </select>                        
                        <p class="help-block"></p>
